(function () {
  ...
  function initNetwork() {
    ...
    createGradient('hubGradient', [
      { offset: '0%', color: '#fff4e6', opacity: 1 },
      { offset: '52%', color: '#f7c59f', opacity: 0.95 },
      { offset: '100%', color: '#8c1515', opacity: 1 }
    ]);

    createGradient('sectionGradient', [
      { offset: '0%', color: '#ffe8c2', opacity: 1 },
      { offset: '55%', color: '#f6b1a0', opacity: 0.95 },
      { offset: '100%', color: '#b1040e', opacity: 1 }
    ]);

    createGradient('supportGradient', [
      { offset: '0%', color: '#f7f4ed', opacity: 0.95 },
      { offset: '60%', color: '#d0c4b5', opacity: 0.9 },
      { offset: '100%', color: '#4d4f53', opacity: 1 }
    ]);

    createGradient(
      'axonGlow',
      [
        { offset: '0%', color: 'rgba(253, 181, 21, 0.6)' },
        { offset: '50%', color: 'rgba(224, 79, 57, 0.25)' },
        { offset: '100%', color: 'rgba(46, 45, 41, 0)' }
      ],
      { fx: '50%', fy: '45%', r: '72%' }
    );
